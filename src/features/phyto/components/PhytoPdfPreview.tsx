        ...
        <div className="px-6 py-6 max-h-[70vh] overflow-y-auto">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-0">
              ...
              <Field label="II. Declared name and address of consignee" value="— address pending from buyer reply —" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-0">
              <Field label="VI. Means of conveyance" value={`Vessel ${container.vessel} / Voy ${container.voyage}`} />
